...
void HAL_ADC_ConvCpltCallback(ADC_HandleTypeDef* hadc)
{
	if(hadc==&hadc1)
	{
        ...
        value2=0;
        value3=0;
        while(i<=ADC_BUFFER_LENGTH-3)
        {
           value1+=ADCBuffer[i];
           value2+=ADCBuffer[i+1];
           value3+=ADCBuffer[i+2];
           i+=3;
        }
        value1=value1/ADC_BUFFER_LENGTH/3;
        value2=value2/ADC_BUFFER_LENGTH/3;
        value3=value3/ADC_BUFFER_LENGTH/3;
	}
}
...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  sprintf(UART_Buffer,"DMA ADC value1 = % 4lu , value2 = % 4lu . Value3 = % 4lu \r",value1,value2,value3);
